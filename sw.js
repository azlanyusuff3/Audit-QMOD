const CACHE='audit-qmod-v5.12';
const MASTER='./Audit_QMOD_Master_Templates.xlsx';
const SHELL=['./index.html','./app.js?v=5.12','./audit-data.js?v=5.12','./manifest.json','./icon-192.png','./icon-512.png',MASTER,'./Audit_QMOD_SOP_Template.xlsx'];
